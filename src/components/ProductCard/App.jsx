...
const ProductCard = () => {
  return (
    <div className="product-details">
      <h2 className="product-title">Tênis Nike Revolution 6 Next Nature Masculino</h2>
      ...
      <div className="color-selection">
        ...
        <div className="color-options">
          <span className="color-circle" style={{ backgroundColor: '#00c3ff' }}></span>
          <span className="color-circle" style={{ backgroundColor: '#ff5c5c' }}></span>
          <span className="color-circle" style={{ backgroundColor: '#555' }}></span>
          <span className="color-circle" style={{ backgroundColor: '#8a57f2' }}></span>
        </div>
      </div>
